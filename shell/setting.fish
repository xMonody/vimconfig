...
set zoxide_fish $HOME/.config/fzf/zoxide.fish
if test -f $fzf_fish
    source $fzf_fish
...
if set -q MSYSTEM
    ...
    set -x PATH /d/Edit/nvim/bin $PATH
    set -x PATH "/c/Users/xx/AppData/Local/Programs/Microsoft VS Code" $PATH
    alias vim nvim
end
...
if status is-interactive
    ...
    function fish_prompt
        ...
        echo
        echo -n (set_color 7F81AF)" ❯ "$_reset
