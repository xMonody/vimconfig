...
vim.api.nvim_set_hl(0, '@constant.macro', { fg = '#B766AD', bg = 'NONE', italic = true })--宏定义
vim.api.nvim_set_hl(0, 'Constant',        { fg = '#D55F6F', bg = 'NONE', italic = false })--常量
vim.api.nvim_set_hl(0, 'Number',          { fg = '#D55F6F', bg = 'NONE', italic = false })
