...
vim.api.nvim_create_autocmd("ColorScheme", {
  ...
  callback = function()
    ...
    vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { fg = "#ff9999", bg = "NONE" })
    ...
    vim.api.nvim_set_hl(0, "DiagnosticUnderlineError",   { fg = "#ff9999", bg = "NONE" })
    vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn",    { fg = "#eed49f", bg = "NONE" })
...
vim.api.nvim_set_hl(0, 'Structure',     { fg = '#317272', bg = 'NONE' })
...
vim.api.nvim_set_hl(0,'@lsp.type.Class',                  {fg='#a54a5d',bg= 'NONE', italic= false })
vim.api.nvim_set_hl(0,'@lsp.typemod.class.defaultLibrary',{fg='#a54a5d',bg= 'NONE', italic= false })
vim.api.nvim_set_hl(0, 'Type',                            {fg='#ef9f76',bg= 'NONE', italic= false })
vim.api.nvim_set_hl(0, '@type.builtin',                   {fg='#ef9f76',bg= 'NONE', italic= false })

vim.api.nvim_set_hl(0,'@variable.builtin',      {fg= '#ac797b',bg= 'NONE', italic=true })--cout cin
vim.api.nvim_set_hl(0,'@lsp.type.TypeParameter',{fg= '#ac797b',bg= 'NONE', italic=true })--模板参数
vim.api.nvim_set_hl(0,'@lsp.type.variable',     {fg= '#ac797b',bg= 'NONE', italic=true })--变量
vim.api.nvim_set_hl(0,'@lsp.type.parameter',    {fg= '#749395',bg= 'NONE', italic=true })--函数变量
vim.api.nvim_set_hl(0,'@lsp.type.property',     {fg= '#7c73b0',bg= 'NONE', italic=true })--类成员变量
...
vim.api.nvim_set_hl(0, 'cPreCondit',      { fg = '#a54a5d', bg = 'NONE', italic = false })
vim.api.nvim_set_hl(0, 'cDefine',         { fg = '#a54a5d', bg = 'NONE', italic = false })
vim.api.nvim_set_hl(0, 'Macro',           { fg = '#a54a5d', bg = 'NONE', italic = false })
vim.api.nvim_set_hl(0, 'PreProc',         { fg = '#a54a5d', bg = 'NONE', italic = false })
vim.api.nvim_set_hl(0, 'include',         { fg = '#a54a5d', bg = 'NONE', italic = false })

vim.api.nvim_set_hl(0, '@constant.macro', { fg = '#F7768E', bg = 'NONE', italic = true })--宏定义
vim.api.nvim_set_hl(0, '@constant.macro', { fg = '#F7768E', bg = 'NONE', italic = true })--宏定义
vim.api.nvim_set_hl(0, 'Constant',        { fg = '#E78284', bg = 'NONE', italic = true })--常量
vim.api.nvim_set_hl(0, 'Number',          { fg = '#E78284', bg = 'NONE', italic = true })


vim.api.nvim_set_hl(0, 'CmpItemAbbrMatchFuzzy', { fg = '#68a0e1', bg = 'NONE', italic = false })
vim.api.nvim_set_hl(0, 'CmpItemAbbrMatch',      { fg = '#68a0e1', bg = 'NONE', italic = false })

vim.api.nvim_set_hl(0, 'PmenuSel',    { bg = '#3B3F52', fg = 'NONE', italic = false })
